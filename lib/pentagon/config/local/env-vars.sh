...
LIST_OF_CONFIG_VARIABLES=( "TF_VAR_aws_access_key" "AWS_ACCESS_KEY" "AWS_DEFAULT_REGION" "ANSIBLE_CONFIG" "KUBECONFIG" "INFRASTRUCTURE_BUCKET")
LIST_OF_SECRET_VARIABLES=( "TF_VAR_aws_secret_key" "AWS_SECRET_KEY" )
