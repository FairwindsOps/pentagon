export CLUSTER_NAME=production.example.com
export ZONES="us-east-1a,us-east-1b,us-east-1c"
export VPC_ID="vpc-c952aba0"

# the public key to be installed for the admin user
# this should be set to be unique per cluster
export SSH_KEY_PATH="${HOME}/workspace/projects/<projectname>/<projectname>-infrastructure/config/private/production.pub"
