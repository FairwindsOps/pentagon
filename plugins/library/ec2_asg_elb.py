...
---
module: ec2_asg
short_description: Register/Deregister AWS Autoscaling Groups from AWS Elastic Load Balancers
description:
  - Can register or deregister AWS Autoscaling Groups from AWS Elastic Load Balancers
options:
  state:
    description:
      - register or deregister the ASG
    required: true
    choices: ['register', 'deregister']
  name:
    description:
      - Unique name for group to be registered or deregistered
    required: true
  load_balancers:
    description:
